...
- Household entry: `/h/<slug>`, members login only. Not yet deployed.
...
Live household setup still requires the owner's Google/WorkOS sign-in test. Entry is local-only until reviewed and deployed.
