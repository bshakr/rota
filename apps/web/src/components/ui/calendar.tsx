...
// en-GB in the browser ("28/06/2026"). They disagree, and React throws a
// hydration mismatch on every render of this component. Do not remove the
// default. See src/lib/date.ts.
function Calendar({
  className,
  classNames,
